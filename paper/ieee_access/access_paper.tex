...
Spatiotemporal Flood Risk Modeling Under a Single-Orbit Synthetic Aperture Radar Constraint: Confound-Controlled Susceptibility, Flood-Aware Routing, and Hybrid Quantum Dispatch\par}
...
\item A hybrid quadratic unconstrained binary optimization (QUBO) and quantum approximate optimization algorithm (QAOA) dispatch layer verified against the exact classical
