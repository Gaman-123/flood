...
% Author identities removed for anonymous review.
% Restore the \IEEEauthorblockN / \IEEEauthorblockA block before camera-ready.
\author{}
...
% Acknowledgment section removed: it named an author and the institution, which
% would defeat anonymisation. Restore before camera-ready.
